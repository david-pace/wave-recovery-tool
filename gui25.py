...
class WaveRecoveryToolGUI(QMainWindow):
    def __init__(self):
        ...
        # Khởi tạo danh sách các luồng làm việc
        self.worker_threads = []
    ...
    def initRestoreForm(self):
        ...
        self.progress_bar.setStyleSheet("QProgressBar::chunk { background-color: green; } QProgressBar { text-align: center; color: white; }")
